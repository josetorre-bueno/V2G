...
const MANUAL = [
  ...
  },
  {
    ...
    body: "Load a Circuit CSV to run automatically, or fill in the circuit fields manually and click \u25b6 Run Analysis. The Optimized model always runs. The Uncoordinated model runs only when household load data has been loaded from a Green Button file. Results appear immediately — all calculation is done in the browser.",
  },
  {
